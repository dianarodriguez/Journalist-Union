...
/*
 * ReporteCategPer.java
 *
 * Created on 06-abr-2012, 15:11:38
 */
 ...
 * @author asus
 */
public class ReporteCategPer extends javax.swing.JDialog {

    /** Creates new form ReporteCategPer */
    public ReporteCategPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Categoría Docente por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/categ_peri.jasper");
            ...
            parameters.put("idper", idperiod);
              parameters.put("nombrep",nombreper);
            ...
            Logger.getLogger(ReporteCategPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteCategPer dialog = new ReporteCategPer(new javax.swing.JFrame(), true);
