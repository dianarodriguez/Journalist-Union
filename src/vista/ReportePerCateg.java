...
/*
 * ReportePerCateg.java
 *
 * Created on 07-abr-2012, 21:59:21
 */
 ...
 * @author asus
 */
public class ReportePerCateg extends javax.swing.JDialog {

    /** Creates new form ReportePerCateg */
    public ReportePerCateg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por categoría Docente");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/period_categ.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            CategoriaDocente aux = null;
            PeriodistaControl pc = new PeriodistaControl();
            String nombrecateg = String.valueOf(jComboBox1.getSelectedItem());
            ...
            parameters.put("nombrec", nombrecateg);
            ...
            Logger.getLogger(ReportePerCateg.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerCateg dialog = new ReportePerCateg(new javax.swing.JFrame(), true);
