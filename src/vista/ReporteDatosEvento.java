...
/*
 * ReporteDatosEvento.java
 *
 * Created on 09-abr-2012, 11:39:23
 */
 ...
 * @author asus
 */
public class ReporteDatosEvento extends javax.swing.JDialog {

    /** Creates new form ReporteDatosEvento */
    public ReporteDatosEvento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Caracterización del Evento");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_evento.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Evento aux = null;
            // String nombred = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Evento) jComboBox1.getSelectedItem();
            int ide = aux.getIdEvento();
            //   jTextField1.setText(String.valueOf(idperiod));
            parameters.put("ide", ide);
            ...
            Logger.getLogger(ReporteDatosEvento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosEvento dialog = new ReporteDatosEvento(new javax.swing.JFrame(), true);
