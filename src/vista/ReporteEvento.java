 ...
 * ReporteEvento.java
 *
 * Created on 06-abr-2012, 17:55:41
 */
 ...
 * @author asus
 */
public class ReporteEvento extends javax.swing.JDialog {

    /** Creates new form ReporteEvento */
    public ReporteEvento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Eventos por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/event_per.jasper");
            ...
            Logger.getLogger(ReporteEvento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteEvento dialog = new ReporteEvento(new javax.swing.JFrame(), true);
