 ...
 * ReporteIdioma.java
 *
 * Created on 06-abr-2012, 18:17:36
 */
 ...
 * @author asus
 */
public class ReporteIdioma extends javax.swing.JDialog {

    /** Creates new form ReporteIdioma */
    public ReporteIdioma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Idioma por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/idioma_per.jasper");
            ...
            Logger.getLogger(ReporteIdioma.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteIdioma dialog = new ReporteIdioma(new javax.swing.JFrame(), true);
