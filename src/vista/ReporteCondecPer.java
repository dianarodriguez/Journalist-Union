...
/*
 * ReporteCondecPer.java
 *
 * Created on 06-abr-2012, 17:13:09
 */
 ...
 * @author asus
 */
public class ReporteCondecPer extends javax.swing.JDialog {

    /** Creates new form ReporteCondecPer */
    public ReporteCondecPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Condecoración por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/condec_per.jasper");
            ...
            Logger.getLogger(ReporteCondecPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteCondecPer dialog = new ReporteCondecPer(new javax.swing.JFrame(), true);
