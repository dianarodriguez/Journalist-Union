...
/*
 * ReporteDatosCirculo.java
 *
 * Created on 09-abr-2012, 11:02:47
 */
 ...
 * @author asus
 */
public class ReporteDatosCirculo extends javax.swing.JDialog {

    /** Creates new form ReporteDatosCirculo */
    public ReporteDatosCirculo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        circuloEspecialList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : circuloEspecialQuery.getResultList();
        ...
        setTitle("Círculo Especializado");
        setResizable(false);
        ...
        jLabel2.setText("Círculo Especializado:");
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
      JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_circulo.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            CirculoEspecial aux = null;
            //  String nombred = String.valueOf(jComboBox1.getSelectedItem());
            aux = (CirculoEspecial) jComboBox1.getSelectedItem();
            int idc = aux.getIdCirculoe();
            ...
            Logger.getLogger(ReporteDatosCirculo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosCirculo dialog = new ReporteDatosCirculo(new javax.swing.JFrame(), true);
