...
/*
 * ReportePerEvento.java
 *
 * Created on 07-abr-2012, 22:55:31
 */
 ...
 * @author asus
 */
public class ReportePerEvento extends javax.swing.JDialog {

    /** Creates new form ReportePerEvento */
    public ReportePerEvento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por Evento");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_evento.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Evento aux = null;
            String nombree = String.valueOf(jComboBox1.getSelectedItem());
            ...
            parameters.put("nombree", nombree);
            ...
            Logger.getLogger(ReportePerEvento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerEvento dialog = new ReportePerEvento(new javax.swing.JFrame(), true);
