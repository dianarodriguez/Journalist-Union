...
/*
 * ReporteCargoPPer.java
 *
 * Created on 09-abr-2012, 19:39:44
 */
 ...
 * @author asus
 */
public class ReporteCargoPPer extends javax.swing.JDialog {

    /** Creates new form ReporteCargoPPer */
    public ReporteCargoPPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Cargo Periodístico por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/nuevo.jasper");
            ...
            parameters.put("idper", idperiod);
             parameters.put("cargo", nombreper);
            ...
            Logger.getLogger(ReporteCargoPPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteCargoPPer dialog = new ReporteCargoPPer(new javax.swing.JFrame(), true);
