...
/*
 * ReportePerCirculo.java
 *
 * Created on 07-abr-2012, 22:17:48
 */
 ...
 * @author asus
 */
public class ReportePerCirculo extends javax.swing.JDialog {

    /** Creates new form ReportePerCirculo */
    public ReportePerCirculo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por Círculo Especializado");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_circulo.jasper");
            ...
            int idcirc = aux.getIdCirculoe();
            //   jTextField1.setText(String.valueOf(idperiod));
            parameters.put("idcirc", idcirc);
            ...
            Logger.getLogger(ReportePerCirculo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerCirculo dialog = new ReportePerCirculo(new javax.swing.JFrame(), true);
