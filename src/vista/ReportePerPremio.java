...
/*
 * ReportePerPremio.java
 *
 * Created on 08-abr-2012, 21:57:49
 */
 ...
 * @author asus
 */
public class ReportePerPremio extends javax.swing.JDialog {

    /** Creates new form ReportePerPremio */
    public ReportePerPremio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por Premio");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_premio.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Premio aux = null;
            String premio = String.valueOf(jComboBox1.getSelectedItem());
            ...
            Logger.getLogger(ReportePerPremio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerPremio dialog = new ReportePerPremio(new javax.swing.JFrame(), true);
