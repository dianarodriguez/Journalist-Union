...
/*
 * ReporteDatosDeleg.java
 *
 * Created on 09-abr-2012, 14:27:38
 */
 ...
 * @author asus
 */
public class ReporteDatosDeleg extends javax.swing.JDialog {

    /** Creates new form ReporteDatosDeleg */
    public ReporteDatosDeleg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Caracterización de la Delegación");
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            Logger.getLogger(ReporteDatosDeleg.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosDeleg dialog = new ReporteDatosDeleg(new javax.swing.JFrame(), true);
