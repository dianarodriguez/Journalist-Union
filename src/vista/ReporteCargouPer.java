...
/*
 * ReporteCargouPer.java
 *
 * Created on 05-abr-2012, 11:58:58
 */
 ...
 * @author asus
 */
public class ReporteCargouPer extends javax.swing.JDialog {

    /** Creates new form ReporteCargouPer */
    public ReporteCargouPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Cargo en la UPEC de determinado periodista");
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/cargou_per.jasper");
            ...
            Logger.getLogger(ReporteCargouPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteCargouPer dialog = new ReporteCargouPer(new javax.swing.JFrame(), true);
