 ...
 * ReporteDatosPC.java
 *
 * Created on 09-abr-2012, 11:15:47
 */
 ...
 * @author asus
 */
public class ReporteDatosPC extends javax.swing.JDialog {

    /** Creates new form ReporteDatosPC */
    public ReporteDatosPC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Carcaterización de PC");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
      JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_comput.jasper");
            ...
            Logger.getLogger(ReporteDatosPC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosPC dialog = new ReporteDatosPC(new javax.swing.JFrame(), true);
