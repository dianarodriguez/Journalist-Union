...
/*
 * ReportePerIdioma.java
 *
 * Created on 07-abr-2012, 23:10:01
 */
 ...
 * @author asus
 */
public class ReportePerIdioma extends javax.swing.JDialog {

    /** Creates new form ReportePerIdioma */
    public ReportePerIdioma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por Idioma");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_idioma.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Idioma aux = null;
            String nombrei = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Idioma) jComboBox1.getSelectedItem();
            int idi = aux.getIdIdioma();
            //   jTextField1.setText(String.valueOf(idperiod));
            parameters.put("ididioma", idi);
            parameters.put("nombrei", nombrei);
            ...
            Logger.getLogger(ReportePerIdioma.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerIdioma dialog = new ReportePerIdioma(new javax.swing.JFrame(), true);
