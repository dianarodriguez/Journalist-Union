 ...
 * ReporteBajaPer.java
 *
 * Created on 07-abr-2012, 21:25:34
 */
 ...
 * @author asus
 */
public class ReporteBajaPer extends javax.swing.JDialog {

    /** Creates new form ReporteBajaPer */
    public ReporteBajaPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mostrar Periodista que son baja:");
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
         JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/baja_per.jasper");
            ...
            Logger.getLogger(ReporteBajaPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteBajaPer dialog = new ReporteBajaPer(new javax.swing.JFrame(), true);
