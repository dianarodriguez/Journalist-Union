...
/*
 * ReportePerCurso.java
 *
 * Created on 08-abr-2012, 21:39:13
 */
 ...
 * @author asus
 */
public class ReportePerCurso extends javax.swing.JDialog {

    /** Creates new form ReportePerCurso */
    public ReportePerCurso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Periodistas por Curso Postgrado");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_postgrado.jasper");
            ...
            Logger.getLogger(ReportePerCurso.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerCurso dialog = new ReportePerCurso(new javax.swing.JFrame(), true);
