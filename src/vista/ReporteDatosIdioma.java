...
/*
 * ReporteDatosIdioma.java
 *
 * Created on 09-abr-2012, 11:57:53
 */
 ...
 * @author asus
 */
public class ReporteDatosIdioma extends javax.swing.JDialog {

    /** Creates new form ReporteDatosIdioma */
    public ReporteDatosIdioma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        idiomaList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : idiomaQuery.getResultList();
        ...
        setTitle("Caracterización del idioma");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_idioma.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Idioma aux = null;
            // String nombred = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Idioma) jComboBox1.getSelectedItem();
            int idi = aux.getIdIdioma();
            //   jTextField1.setText(String.valueOf(idperiod));
            parameters.put("idi", idi);
            ...
            Logger.getLogger(ReporteDatosIdioma.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosIdioma dialog = new ReporteDatosIdioma(new javax.swing.JFrame(), true);
