...
/*
 * ReportePostgradoPer.java
 *
 * Created on 06-abr-2012, 19:09:48
 */
 ...
 * @author asus
 */
public class ReportePostgradoPer extends javax.swing.JDialog {

    /** Creates new form ReportePostgradoPer */
    public ReportePostgradoPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Cursos Postgrados por Periodistas ");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/postgrado_per.jasper");
            ...
            Logger.getLogger(ReportePostgradoPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePostgradoPer dialog = new ReportePostgradoPer(new javax.swing.JFrame(), true);
