...
/*
 * ReporteDatosPremio.java
 *
 * Created on 09-abr-2012, 14:06:09
 */
 ...
 * @author asus
 */
public class ReporteDatosPremio extends javax.swing.JDialog {

    /** Creates new form ReporteDatosPremio */
    public ReporteDatosPremio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        premioList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : premioQuery.getResultList();
        ...
        setTitle("Carcaterización del Premio");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_premio.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Premio aux = null;
            // String nombred = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Premio) jComboBox1.getSelectedItem();
            int idp = aux.getIdPremio();
            ...
            Logger.getLogger(ReporteDatosPremio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosPremio dialog = new ReporteDatosPremio(new javax.swing.JFrame(), true);
