...
/*
 * ReporteDatosMision.java
 *
 * Created on 09-abr-2012, 12:08:09
 */
 ...
 * @author asus
 */
public class ReporteDatosMision extends javax.swing.JDialog {

    /** Creates new form ReporteDatosMision */
    public ReporteDatosMision(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Caracterización de la Misión");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_mision.jasper");
            ...
            Logger.getLogger(ReporteDatosMision.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosMision dialog = new ReporteDatosMision(new javax.swing.JFrame(), true);
