 ...
 * ReporteCompPer.java
 *
 * Created on 06-abr-2012, 17:00:24
 */
 ...
 * @author asus
 */
public class ReporteCompPer extends javax.swing.JDialog {

    /** Creates new form ReporteCompPer */
    public ReporteCompPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Computadoras por Periodista");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
       JOptionPane.showMessageDialog(null, "Espere unos segundos mientras se genera el reporte.");
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/comput_per.jasper");
            ...
            Logger.getLogger(ReporteCompPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteCompPer dialog = new ReporteCompPer(new javax.swing.JFrame(), true);
