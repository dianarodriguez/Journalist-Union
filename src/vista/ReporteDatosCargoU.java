...
/*
 * ReporteDatosCargoU.java
 *
 * Created on 09-abr-2012, 15:16:44
 */
 ...
 * @author asus
 */
public class ReporteDatosCargoU extends javax.swing.JDialog {

    /** Creates new form ReporteDatosCargoU */
    public ReporteDatosCargoU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Carcaterización del Cargo de la UPEC");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            Logger.getLogger(ReporteDatosCargoU.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosCargoU dialog = new ReporteDatosCargoU(new javax.swing.JFrame(), true);
