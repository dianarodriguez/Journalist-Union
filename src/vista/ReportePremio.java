 ...
 * ReportePremio.java
 *
 * Created on 06-abr-2012, 19:34:19
 */
 ...
 * @author asus
 */
public class ReportePremio extends javax.swing.JDialog {

    /** Creates new form ReportePremio */
    public ReportePremio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Premio por Periodistas ");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/premio_per.jasper");
            ...
            Logger.getLogger(ReportePremio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePremio dialog = new ReportePremio(new javax.swing.JFrame(), true);
