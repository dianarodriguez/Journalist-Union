...
/*
 * ReporteDatosPer.java
 *
 * Created on 08-abr-2012, 22:51:23
 */
 ...
 * @author asus
 */
public class ReporteDatosPer extends javax.swing.JDialog {

    /** Creates new form ReporteDatosPer */
    public ReporteDatosPer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/datos_peri.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Periodista aux = null;
            String period = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Periodista) jComboBox1.getSelectedItem();
            int idp = aux.getIdPeriodista();
            ...
            Logger.getLogger(ReporteDatosPer.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteDatosPer dialog = new ReporteDatosPer(new javax.swing.JFrame(), true);
