 ...
 * ReportePerPC.java
 *
 * Created on 09-abr-2012, 15:03:39
 */
 ...
 * @author asus
 */
public class ReportePerPC extends javax.swing.JDialog {

    /** Creates new form ReportePerPC */
    public ReportePerPC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        computadorasList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : computadorasQuery.getResultList();
        ...
        setTitle("Periodistas por Computadora");
        setResizable(false);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/ReportesD/per_pc.jasper");
            //Pasamos parametros al reporte Jasper.
            Map parameters = new HashMap();
            Computadoras aux = null;
            String nombred = String.valueOf(jComboBox1.getSelectedItem());
            aux = (Computadoras) jComboBox1.getSelectedItem();
            int idp = aux.getIdPc();
            //   jTextField1.setText(String.valueOf(idperiod));
            parameters.put("idpc", idp);
            parameters.put("cod", nombred);
            ...
            Logger.getLogger(ReportePerPC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportePerPC dialog = new ReportePerPC(new javax.swing.JFrame(), true);
